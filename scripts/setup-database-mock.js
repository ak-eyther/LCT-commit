...
async function setupMockDatabase() {
  try {
    console.log('🔧 Setting up LCT authentication (mock mode for local development)...');
    ...
    const mockUsers = {
      "arif.khan@vitraya.com": {
        ...
        passwordHash: "$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj5J5K5K5K5K", // Mock hash for local testing
    ...
    console.log('   2. Use credentials from your local setup');
